...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style34"><span class="style12">Friends Posts.. </span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
            ...
            <div>
              <table width="646" border="1" align="center"  cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td  width="182" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57 style62">Friend Image </div></td>
                  <td  width="161" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style56 style57 style62">Friend Name</div></td>
                ...
                <%
						...
						try 
						{
							String uname1 = (String)application.getAttribute("uname");
						   	...
						   	String query="select distinct(user) from posts"; 
					   		...
					   		while ( rs.next() )
					   		{
								...
								String strQuery2 = "select requestfrom,requestto from frequest where ((requestfrom ='"+uname1+"' and requestto='"+s1+"') ||(requestfrom ='"+s1+"' and requestto='"+uname1+"'))and status ='Accepted' ";
                ...
                <tr>
                  ...
                  <td height="0" align="center"  valign="middle"><div class="style22 style4 style5 style65" style="margin:10px 13px 10px 13px;" >
                      <div align="center"><a class="#" id="img1" href="#" >
                        <input  name="image" type="image" src="images1.jsp?imgname=<%=s1%>" style="width:140px; height:140px;" />
                      </a> </div>
                  </div></td>
                  ...
                  <td><label> </label>
                      <form method="post" action="U_ViewFriendsPostsDetails.jsp">
                        <label>
                        <div align="center">
                          <p>
...
%>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li>
              <p><a href="U_CyberFriendsPosts.jsp">Home</a></p>
