			...
			%>
              <table border="1" align="left" cellpadding="0" cellspacing="0" >
                  <tr >
                    ...
                    <td height="47" bgcolor="#FF0000" ><div align="center" class="style70 style73">Created By  </div></td>
                    <td><div align="center" class="style69"><strong><%= user%></strong></div></td>
                  </tr>
                  <tr >
                    <td height="47" bgcolor="#FF0000" ><div align="center" class="style83"> Date  </div></td>
                    <td><div align="center" class="style69"><strong><%= date%></strong></div></td>
                  </tr>
                  <tr >
                    <td height="47" bgcolor="#FF0000" ><div align="center" class="style83">Post Uses  </div></td>
                    <td>
                          <textarea name="textarea2" cols="50" rows="6"><%= uses%></textarea>                    </td>
                  </tr>
                <tr >
                  <td width="123" height="74" bgcolor="#FF0000" ><div align="center" class="style83">Post Description  </div></td>
                  <td>
                        <textarea name="textarea" cols="50" rows="8"><%= description%></textarea>                  </td>
                </tr>
                ...
                <tr>
                  <td  width="147" height="29" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style11 style71 style77 style81" style="margin-left:20px;">
                    <div align="center">Feedback By</div>
                  </div></td>
                  <td  width="123" height="29" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11 style71 style77 style81" style="margin-left:20px;">
                    <div align="center">Date</div>
                  </div></td>
                  <td  width="302" height="29" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style81 style11 style71 style77" style="margin-left:20px;">
              ...
              <%a=1;}%>
                ...
                <tr>
                  <td height="40"><div align="center" class="style78 style10 style9 style80 style82"><strong><%= c_user%></strong></div></td>
                  <td><div align="center" class="style78 style10 style9 style80 style82"><strong><%= c_date%></strong></div></td>
                  <td><div align="center" class="style78 style82 style10 style9 style80"><strong><%= c_comment%></strong></div></td>
                </tr>
               <%}%><br/>
              </table>
                <%
