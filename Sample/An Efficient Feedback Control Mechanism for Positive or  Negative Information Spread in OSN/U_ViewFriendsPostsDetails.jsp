...
<head>
<title>Friends Posts Details..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style34"><span class="style12">Friend <span class="style17"><%=request.getParameter("username")%></span> Posts Details.. </span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
			...
			<%
					...
					String str1="select * from posts where user='"+user+"' "; 
					Statement st1=connection.createStatement();
					ResultSet rs1=st1.executeQuery(str1);
					while ( rs1.next() )
					{
						int i=rs1.getInt(1);
						String p_Name = rs1.getString(3);
			...
			%>
              <table border="1" align="left" cellpadding="0" cellspacing="0" >
                  <tr >
                    ...
                    <td><div align="center" class="style15"><strong><%= p_Name%></strong></div></td>
                  </tr>
                  <tr >
                    <td height="47" bgcolor="#FF0000" ><div align="center" class="style80"> Date  </div></td>
                    <td><div align="center" class="style15"><strong><%= date%></strong></div></td>
                  </tr>
                  <tr >
                    <td height="47" bgcolor="#FF0000" ><div align="center" class="style80">Post Uses  </div></td>
                    <td><div align="center" class="style15"><strong><%= uses%></strong></div></td>
                  </tr>
                <tr >
                  <td width="131" height="74" bgcolor="#FF0000" ><div align="center" class="style80">Post Description  </div></td>
                  <td><div align="center" class="style15"><strong><%= description%></strong></div></td>
                </tr>
                ...
                <tr>
				 ...
				 <%
						int a=0;
						String str2="select * from postcomments where title='"+p_Name+"' "; 
                ...
                <tr>
                  <td  width="153" height="31" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style11 style71 style77 style79" style="margin-left:20px;">
                    <div align="center">Feedback By</div>
                  </div></td>
                  <td  width="131" height="31" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11 style71 style77 style79" style="margin-left:20px;">
                    <div align="center">Date</div>
                  </div></td>
                  <td  width="305" height="31" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11 style71 style77 style79" style="margin-left:20px;">
                    <div align="center">Feedback Details</div>
                  </div></td>
                </tr>
              <%a=1;}%>

                <tr>
                  <td height="43"><div align="center" class="style78 style10 style9 style15"><strong><%= c_user%></strong></div></td>
                  <td><div align="center" class="style78 style10 style9 style15"><strong><%= c_date%></strong></div></td>
                  <td><div align="center" class="style78 style15 style10 style9"><strong><%= c_comment%></strong></div></td>
                </tr>
               <%}}%>
                <tr>
                  <td height="57"><div align="left " class="style15 style11" style="margin-left:20px;">
                      <div align="center"><strong>Post Your Feedback </strong></div>
                  </div></td>
                  <td colspan="2"><form id="form1" name="form1" method="post" action="U_AddFeedback.jsp">
...
%>
          ...
          <div class="clr"></div>
          <div align="right"><a href="U_ViewFriendsPosts.jsp" class="style63">Back</a></div>
        </div>
        <div class="article">
          <h2 class="style31">&nbsp;</h2>
        </div>
