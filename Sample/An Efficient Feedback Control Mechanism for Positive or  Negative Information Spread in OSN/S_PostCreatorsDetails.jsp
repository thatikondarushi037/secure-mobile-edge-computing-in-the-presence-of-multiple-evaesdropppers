...
<head>
<title>Post Creator's Details..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style1"><span class="style36 style35"><span class="style41">Post </span><span class="style43"><%=request.getParameter("title")%></span><span class="style41">'s Ownner..</span></span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
            <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
              ...
              <tr>
                <td valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style39" style="margin-left:20px;"><strong>Created By </strong></div></td>
                <td valign="middle" height="40" style="color:#000000;"><div align="left" class="style10 style22 style40" style="margin-left:20px;">
                    <%out.println(user);%>
                </div></td>
              </tr>
              <tr>
            ...
            <p>&nbsp;</p>
            <p align="right"><a href="index.html" class="style10"></a> <a href="S_AllPosts.jsp" class="style10">Back</a></p>
          </div>
          <div class="clr"></div>
        </div>
        <div class="article">
