			...
			%>
              <table border="1" align="left" cellpadding="0" cellspacing="0" >
                  <tr >
                    ...
                    <td><div align="center" class="style69"><strong><%= p_Name%></strong></div></td>
                  </tr>
                  <tr >
                ...
                <tr>
                  <td  width="153" height="24" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style11 style71 style77 style81" style="margin-left:20px;">
                    <div align="center">Comment By</div>
                  </div></td>
                  <td  width="131" height="24" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11 style71 style77 style81" style="margin-left:20px;">
                    <div align="center">Date</div>
                  </div></td>
                  <td  width="305" height="24" align="center" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;" columnspan="2"><div align="left " class="style11 style71 style77 style81" style="margin-left:20px;">
              ...
              <%a=1;}%>
                ...
                <tr>
                  <td height="49"><div align="center" class="style78 style76 style10 style9"><strong><%= c_user%></strong></div></td>
               ...
               <%}}%>
                <tr>
                  ...
                  <td colspan="2"><form id="form1" name="form1" method="post" action="postsubmit.jsp">
                  </form></td>
                </tr>
              <p>&nbsp;</p>
              </table>
...
%>
          ...
          <div class="clr"></div>
          <div align="right"><a href="U_FriendsPosts.jsp" class="style63">Back</a></div>
        </div>
        <div class="article">
          <h2 class="style31">&nbsp;</h2>
        </div>
